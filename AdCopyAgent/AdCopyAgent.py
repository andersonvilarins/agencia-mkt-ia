...
class AdCopyAgent(Agent):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            description="É especializado na geração de textos de anúncios criativos e envolventes usando ferramentas de IA. Avalia o público-alvo e as características do produto/serviço para criar mensagens atraentes.",  # Descrição do propósito e especialização do agente.
